...
def problem2_6():
    ...
    for i in range(100):
        ...
        lis2.append(random.randint(1,6))
        sum_ = lis1[i] + lis2[i]
        print(sum_)
...
def problem2_8(temp_list):
    temp_sum = temp_list[0]
    temp_max = temp_list[0]
    temp_min = temp_list[0]
    
    for temp in range(1,len(temp_list)):
        temp_sum = temp_sum + temp_list[temp]
        temp_max = max(temp_max, temp_list[temp])
        temp_min = min(temp_min, temp_list[temp])
    temp_avr = temp_sum / len(temp_list)
    
    print("Average:",temp_avr)
    print("High:",temp_max) 
    print("Low:",temp_min)
