...
def start_timer():
    ...
    if reps % 2 == 0 and reps < 7:
        count_down(work_sec)
        timer_label.config(text="Work", bg=YELLOW, fg=GREEN, font=(FONT_NAME, 50))
    elif reps % 2 == 1 and reps < 7:
        count_down(short_break_sec)
        timer_label.config(text="Break", bg=YELLOW, fg=PINK, font=(FONT_NAME, 50))
    elif reps == 7:
        count_down(long_break_sec)
        timer_label.config(text="Break", bg=YELLOW, fg=RED, font=(FONT_NAME, 50))
